...
// SendEmail tasks in a currently created session and the htmlbody which you would like to send.
// The func is also looking to the SENDER and RECIPIENT OS environment variables to be set.
